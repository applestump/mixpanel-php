...
class Mixpanel extends MixpanelBase {
    ...
    public function __construct($token, $options = array(), $people=null)
    {
        ...
        if(is_null($people)) {
            $this->setPeople(new People($token, $options));
     ...
     * @return Mixpanel
     */
    public static function getInstance($token, $options = array(), $people=null) {
        if(!isset(self::$_instance)) {
            self::$_instance = new Mixpanel($token, $options, $people);
        }
